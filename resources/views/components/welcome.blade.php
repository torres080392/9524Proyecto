    ...
    <div>
        ...
        <div>
            <div class="flex items-center">
                ...
                <div id="lista-cursos" class="container mx-auto px-4">
                    ...
                    <div class="flex flex-wrap -mx-6">
                        ...
                        <div class="w-full md:w-1/2 lg:w-1/3 px-4 mb-8">
                            <div class="card bg-white rounded-lg shadow-lg">
                                ...
                                <div class="p-6">
                                    <h4 class="text-xl font-bold mb-2">Gestión de personas</h4>
                        ...
                        <div class="w-full md:w-1/2 lg:w-1/3 px-4 mb-8">
                            <div class="card bg-white rounded-lg shadow-lg">
                                ...
                                <div class="p-6">
                                    <h4 class="text-xl font-bold mb-2">Gestión de equipos</h4>
