...
<body class="antialiased">
    ...
    <div class="relative flex items-center justify-center min-h-screen bg-gray-100">
        <div class="text-center">
            <a href="{{ route('login') }}" class="text-lg text-gray-700 underline hover:text-indigo-500 transition-colors duration-300 ease-in-out">
                Entrar al sistema
            </a>
            
            <p> Bienvenido a 95/24Colombia Inventario Tecnologico </p>
            <!-- Aquí puedes agregar tu logo -->
            <a href="https://www.9524colombia.com/reng/index.jsp">
            ...
            @if (Route::has('login'))
                <div class="fixed top-0 right-0 px-6 py-4 sm:block">
                    ...
                    @else
                            ...
                            <!--Habiliar si desea dejar que los usuarios se registren
