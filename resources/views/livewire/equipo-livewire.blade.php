                    ...
                    <tbody>
                        @foreach ($equipos as $equipo)
                            <tr>
                                ...
                                <td>{{ $equipo->nombre }}</td>
                                <td>{{ $equipo->serial }}</td>
                                <td>{{ \DateTime::createFromFormat('Y-m-d H:i:s', $equipo->compra)->format('Y-m-d') }}
                                </td>
                                <td>{{ \DateTime::createFromFormat('Y-m-d H:i:s', $equipo->garatiaInicial)->format('Y-m-d') }}
                                </td>
                                <td>{{ \DateTime::createFromFormat('Y-m-d H:i:s', $equipo->garatiaFinal)->format('Y-m-d') }}
                                </td>
                                <td>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form wire:submit.prevent="update({{ $equipoSeleccionado->id }})"
                            ...
                            <div class="mb-3">
                                <label for="compra" class="form-label">Fecha de compra:</label>
                                <input wire:model='compra'
                                    value="{{ \DateTime::createFromFormat('Y-m-d H:i:s', $equipoSeleccionado->compra)->format('Y-m-d') }}"
                                    type="date" id="compra" name="compra" class="form-control" required>
                                @error('compra')
                                    <div class="text-danger">{{ $message }}</div>
                                @enderror
                            </div>
                            <div class="mb-3">
                                <label for="garatiaInicial" class="form-label">Inicio de garantia:</label>
                                <input wire:model="garatiaInicial"
                                    value="{{ \DateTime::createFromFormat('Y-m-d H:i:s', $equipoSeleccionado->garatiaInicial)->format('Y-m-d') }}"
                                    type="date" id="garatiaInicial" name="garatiaInicial" class="form-control"
                                    required>
                                @error('garatiaInicial')
                                    <div class="text-danger">{{ $message }}</div>
                                @enderror
                            ...
                            <div class="mb-3">
                                <label for="garatiaFinal" class="form-label">Final de garantia:</label>
                                <input wire:model="garatiaFinal"
                                    value="{{ \DateTime::createFromFormat('Y-m-d H:i:s', $equipoSeleccionado->garatiaFinal)->format('Y-m-d') }}"
                                    type="date" id="garatiaFinal" name="garatiaFinal" class="form-control"
                                    required>
                                @error('garatiaFinal')
                                    <div class="text-danger">{{ $message }}</div>
                                @enderror
